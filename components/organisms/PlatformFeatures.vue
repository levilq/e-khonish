<template>
  <section class="py-9 px-4">
    <div class="grid gap-6 md:grid-cols-3 font-bold">
      <!-- Card 1 -->
...
<i18n lang="json">
{
  ...
  "tj": {
    "platform_enables": "Платформа мубодилаи иттилоотро байни мактабҳо, волидон ва донишҷӯён бо таваҷҷӯҳ ба шаффофият ва самаранокӣ фароҳам меорад.",
    ...
    "modules": "Модулҳо барои талабагон, волидон, муаллимон, ки идоракунии онҳоро осон ва қулай мегардонад.",
    "unified": "Эконизоми ягонаи рақамӣ барои ҳамаи иштирокчиёни раванди таълим.ss"
  }
}
</i18n>