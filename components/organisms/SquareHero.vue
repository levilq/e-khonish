...
<i18n lang="json">
{
  ...
  "tj": {
    ...
    "schools": "Мактабҳо",
    "functions_for_managing": "Ҳалли ягона барои идоракунии шабакаи мактабҳо - хоҳ минтақа, вилоят ё ин ки дигар муассисаи таълимӣ.",
    ...
    "parents": "Волидайн",
    "the_platform_helps": "Пешравии фарзанди худро назорат карда, мушкилотро сари вақт пай баред ва кӯмак кунед. Низоми электронӣ дастрасии шаффофро бо ҳама чизҳои муҳим таъмин мекунад.",
    "government_institutions": "Мақомот ва муассисаҳои давлатӣ",
    "manage_teacher": "Назорати пурра дар ҷараёни таълим, кадрҳо ва тамоми низоми маориф. Танзимоти чандир барои ҳама гуна машқҳо."
