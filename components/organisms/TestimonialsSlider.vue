...
<i18n lang="json">
{
  ...
  "tj": {
    "what_schools_say": "Мактабҳо дар бораи платформа чӣ мегӯянд",
    "about_platform": "E-KHONISH",
    "platform_is_already": "Платформа аллакай ба мактабҳои саросари кишвар барои сода кардани идоракунӣ, пурзӯр намудани назорат ва барқарор намудани алоқа бо падару модарон ёрӣ мерасонад. Роҳбаони муассисаҳои таълимӣ осонӣ, шаффофият ва сарфаи воқеии вақтро қайд менамоянд – ҳамаи ин имкон медиҳад таваҷҷуҳ ба мақсади асосӣ: сифати таълим равона карда шавад.",
    "name_1": "Каримов Сиёвуш",
    "speciality_1": "муаллими биология",
    "testimonial_1": "Барномаи EKhonish — низоми электронӣ ва мутамаркази таълим аст, ки барои беҳтарсозии таълими талабагон ва таъмини назорати пурраи равандҳои таълим дар мактаҳо хидмат мекунад. Ин замимаҳо ба муаллимон ва падару модарон барои пайгирӣ ва идоракунии осон ва шаффофи фаъолияти таълимӣ шароит фароҳам меоварад.",
    "name_2": "Шарипов Саидмурод",
    "speciality_2": "Муаллими математика",
    "testimonial_2": "Барномаи EKhonish — абзори ҷомеи таълимӣ ва маъмурист, ки барои рушди таълим ва баланд бардоштани сифати дониш дар Тоҷикистон аҳамияти калон дорад. Барои таълим ва иштироки самараноки тадабагон дар дарсҳо ҳамаи мактабҳои кишвар бояд ба ин низом гузаранд.  Ҳамин тавр, барномаи EKhonish натанҳо сатҳи дониши талабагонро баланд мебардорад, балки назорати таълимро барои муаллимон, мактабҳо ва падару модарон хеле сода ва самаранок мекунад.",
